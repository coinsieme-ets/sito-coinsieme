...
const logFile = path.join(rootDir, 'scratch', 'diagnostica-lotto2B', 'lotto1-http-validation.jsonl');
...
urlsToTest.push({ url: `http://127.0.0.1:${port}/pubblicazioni/70-e-percorsi-di-vita-e-sguardi-al-futuro-ebook/index.html`, slug: '70-e-percorsi-di-vita-e-sguardi-al-futuro-ebook' });
urlsToTest.push({ url: `http://127.0.0.1:${port}/pubblicazioni/guida-allacitta-di-roma-anno-1990/index.html`, slug: 'guida-allacitta-di-roma-anno-1990' });
