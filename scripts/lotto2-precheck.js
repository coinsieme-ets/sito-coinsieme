...
if (lotto2.length !== 20) {
    console.error(`ERRORE: Trovati ${lotto2.length} record per il Lotto 2 invece di 20.`);
    hasErrors = true;
}
...
fs.writeFileSync(path.join(rootDir, 'scratch', 'diagnostica-lotto2B', 'hashes_pre_lotto2.json'), JSON.stringify(hashes, null, 2));
