...
if (lotto3.length !== 20) {
    console.error(`ERRORE: Trovati ${lotto3.length} record per il Lotto 3 invece di 20.`);
    hasErrors = true;
}
...
fs.writeFileSync(path.join(rootDir, 'scratch', 'diagnostica-lotto2B', 'hashes_pre_lotto3.json'), JSON.stringify(hashes, null, 2));
