...
const screenshotsDir = path.join(rootDir, 'scratch', 'screenshots', 'collaudo-lotto2B-lotto3');
if (!fs.existsSync(screenshotsDir)) fs.mkdirSync(screenshotsDir, { recursive: true });

const pages = [
    { url: `http://127.0.0.1:${port}/articoli/l-importanza-del-lavoro-nell-integrazione-sociale-ed-economica-di-ogni-individuo/index.html`, name: 'lotto3-primo' },
    { url: `http://127.0.0.1:${port}/articoli/quando-la-capodarco-era-la-capodarco/index.html`, name: 'lotto3-ultimo' }
];
